...
### Backend API: Render.com (100% БЕСПЛАТНО) ✅
### Frontend TMA: Vercel (100% БЕСПЛАТНО) ✅

---

## 🔧 Option 1: Render.com (Рекомендуется - Бесплатно!)

### Преимущества:
- ✅ **100% БЕСПЛАТНО** (не требует карты!)
- ✅ 750 часов/месяц бесплатно
- ✅ Auto-deploy из GitHub
- ✅ Environment variables UI
- ✅ Logs и monitoring
- ✅ Custom domain (*.onrender.com)
- ✅ Auto-sleep после 15 мин (первый запрос разбудит)

### ⚠️ Важно:
- Первый запрос после сна может занять 30-60 секунд (cold start)
- Для production рекомендую добавить UptimeRobot для keep-alive

### Шаги:

#### 1. Подготовь проект

**НЕ нужно** создавать `railway.json` — Render работает напрямую!
```json
{
